...
* **Data Assimilation:** Using experimental data + higher fidelity results to actually improve predictive capabilities and bound uncertainties, rather than just treating physics like a black box.
* **Others:** **Differentiable Programming (JAX)**, **Benchmarking (CPU vs. GPU)** for scientific computing, and **Uncertainty Quantification (UQ)** to build reliable predictive tools.
